...
print("Value for 'history' key:", sampleDict["class"]["student"]["marks"]["history"])
...
print("Son's updated height (inches):", dict["son's height"])
...
print("Brad's updated salary: $", sampleDict["emp3"]["salary"])
